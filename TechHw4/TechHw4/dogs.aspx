    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">This is a collection of our doggos. They have all been treated and trained so they are excited to be welcomed to your home! </p>
          <p>
            <a href="default.aspx" class="btn btn-primary my-2">Back To Home</a>
            <a href="cats.aspx" class="btn btn-secondary my-2">See our cats!</a>
          </p>
        </div>
      </section>
